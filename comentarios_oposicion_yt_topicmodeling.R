# ----------------------------------------------------------
# Topic modeling comentarios canales de oposición argentina de Youtube
...
topic_labels[2] <- "Programa de análisis histórico y político"
topic_labels[3] <- "Situación política y social en Argentina"
...
colores_topicos <- c(
  ...
  "Programa de análisis histórico y político" = "#3498DB",           # azul
  "Situación política y social en Argentina" = "#E74C3C"   # rojo
)
...
ggplot(tabla_distribucion, aes(x = nombre_topico, y = n, fill = nombre_topico)) +
...
write.xlsx(
  ...
  file = "resultados_comentarios_opisicion_topicmodel.xlsx",
  overwrite = TRUE
)
