# ----------------------------------------------------------
# Topic modeling subtítulos canales libertarios de Youtube
...
sub_lib_bar <- ggplot(top20, aes(x = reorder(word, n), y = n)) +
  ...
  coord_flip() +
  labs(
    title = "Top 20 términos más frecuentes - Subtítulos de videos libertarios",
    x = "Término",
    y = "Frecuencia",
...
topic_labels[2] <- "Batalla cultural"
topic_labels[3] <- "Presidente Milei"
topic_labels[4] <- "Ideología de género"
